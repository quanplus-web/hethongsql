...
file_path = data_dir / "simple_request_merged.xlsx"
...
with pd.ExcelWriter(file_path, engine="openpyxl") as writer:
    ...
    # 3. Bảng REQUEST (Đã gộp đầy đủ chi tiết và file đính kèm vào 1 bảng duy nhất)
    df_request = pd.DataFrame([
        ...
        {
            "REQUEST ID": "RD-001", 
            "TITLE": "Hoàn tiền MISA VAT", 
            "COMPANY": "COMP-001", 
            "ITEM NAME": "Hoàn tiền phần mềm kế toán MISA SME",
            "AMOUNT": 9855000, 
            "CURRENCY": "VND", 
            "ATTACHMENT": "RD-001.ATTACHMENT.hoa_don_vat_misa.pdf",
            "STATUS": "Approved"
        },
        {
            "REQUEST ID": "RD-003", 
            "TITLE": "Nâng cấp dịch vụ đám mây Oracle", 
            "COMPANY": "COMP-004", 
            "ITEM NAME": "Oracle Database Upgrade",
            "AMOUNT": 12000, 
            "CURRENCY": "USD", 
            "ATTACHMENT": "RD-003.ATTACHMENT.hop_dong_dich_vu_oracle.pdf",
            "STATUS": "Pending"
        }
    ])
